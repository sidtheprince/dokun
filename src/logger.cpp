...
Logger::Logger(int code, std::string type) // Usage: Logger(1, "error");
{
    ...
    if(String::lower(type) == "default") std::cerr << "\033[0;37m";
...
#ifdef DOKUN_LINUX // change console color
    if(String::lower(type) == "default") std::cout << "\033[0;37m"; // 37=light gray
...
#ifdef DOKUN_LINUX // change console color
    if(String::lower(logger_ptr->type) == "default") std::cout << "\033[0;37m"; // 37=light gray
