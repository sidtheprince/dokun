...
public: // C++                                                                                                  // Lua
	...
	Texture(void * data, int width, int height, int depth = 1, int channel = 4);        
	~Texture();                
	// normal functions
	...
	// setters -  new! 11/7/2015 
	void set_rect  (int x, int y, int width, int height);   static int set_rect(lua_State *L);// crop a part of the texture
	// opengl-related
