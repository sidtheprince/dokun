...
#include "platform.h" // specify platform and graphics api
#include "types.h"
#include "vector.h"
...
public:
	    ...
	    void clear(double red = 0.0, double green = 0.0, double blue = 0.0, double alpha = 0.0, double depth = 1.0, int stencil = 0);   static int clear(lua_State *L);
