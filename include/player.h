...
Usage:
	...
	player->add(* new Music("res/momentum.wav"));//("res/guardia.ogg"));
	player->add(* new Music("res/Oniku.ogg"));
	player->add(* new Music("res/cup_of_lartey.ogg"));
	player->set_repeat_type(1); // 0=repeat_none, 1=repeat_one, 2=repeat_all
	player->start();
