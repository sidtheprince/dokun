...
#include "platform.h"// specify the platform
#include "window.h"// allows the mouse to move within the window instead of the desktop
#include "image.h" // to apply to cursor
extern "C" {
//#include <xdo.h>
}
